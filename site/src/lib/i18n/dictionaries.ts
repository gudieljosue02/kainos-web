  ...
  en: {
      ...
      markets: [
        {
          region: "Cost delta",
          stat: "30x",
          label: "Cheaper than a new AI-enabled ultrasound system. Same intelligence, a fraction of the capital.",
          source: "GE Healthcare · Siemens Healthineers",
        },
        {
        ...
        {
          region: "Healthcare gap",
          stat: "10M",
          label: "Healthcare workers the world will be short by 2030. AI assistance isn't optional, it's structural.",
          source: "WHO, 2023",
        },
      ],
    },
    ...
    opportunity: {
      ...
      metrics: [
        ...
        {
          value: "$10.7B",
          label: "Global ultrasound market by 2030",
          sub: "~5.4% CAGR · Grand View Research",
        },
        {
          value: "37%",
          label: "CAGR of AI in healthcare market through 2030",
          sub: "Grand View Research",
        },
      ],
      pitchTitle: "Why now",
      pitchPoints: [
  ...
  es: {
      ...
      markets: [
        {
          ...
          stat: "30x",
          label: "Más económico que un ultrasonido nuevo con IA. La misma inteligencia, una fracción del capital.",
          source: "GE Healthcare · Siemens Healthineers",
        },
        {
        ...
        {
          region: "Brecha sanitaria",
          stat: "10M",
          label: "Trabajadores de salud que le faltarán al mundo para 2030. La asistencia de IA no es opcional, es estructural.",
          source: "OMS, 2023",
        },
      ],
    },
    ...
    opportunity: {
      ...
      metrics: [
        ...
        {
          value: "$10.7B",
          label: "Mercado global de ultrasonido para 2030",
          sub: "~5.4% CAGR · Grand View Research",
        },
        {
          value: "37%",
          label: "CAGR del mercado de IA en salud hasta 2030",
          sub: "Grand View Research",
        },
      ],
